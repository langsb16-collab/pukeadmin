...
INSERT INTO "partners" ("id","name","balance","status","created_at") VALUES(1,'강남 지점',5000000,'active','2026-08-02 00:30:55');
INSERT INTO "partners" ("id","name","balance","status","created_at") VALUES(2,'부산 파트너',3200000,'active','2026-08-02 00:30:55');
INSERT INTO "partners" ("id","name","balance","status","created_at") VALUES(3,'브론즈파트너C',800000,'active','2026-08-02 02:27:55');
...
INSERT INTO "game_users" ("id","phone","password","nickname","gems","free_game_limit","free_game_used","status","kicked_at","created_at") VALUES('u001','010-1234-5678','pw_hashed_1','킹카드',150000,10,3,'active',NULL,'2026-08-02 02:43:39');
INSERT INTO "game_users" ("id","phone","password","nickname","gems","free_game_limit","free_game_used","status","kicked_at","created_at") VALUES('u002','010-2345-6789','pw_hashed_2','이에이스',80000,10,1,'active',NULL,'2026-08-02 02:43:39');
INSERT INTO "game_users" ("id","phone","password","nickname","gems","free_game_limit","free_game_used","status","kicked_at","created_at") VALUES('u003','010-3456-7890','pw_hashed_3','박풀하우스',320000,10,5,'active',NULL,'2026-08-02 02:43:39');
...
INSERT INTO "recharge_requests" ("id","user_id","phone","nickname","amount","gems","payment_method","status","admin_memo","created_at","processed_at") VALUES(7,'user_test1','010-1111-2222','테스트유저A',50000,50000,'계좌이체','pending','','2026-08-02 02:45:06',NULL);
INSERT INTO "recharge_requests" ("id","user_id","phone","nickname","amount","gems","payment_method","status","admin_memo","created_at","processed_at") VALUES(8,'user_test2','010-3333-4444','테스트유저B',100000,100000,'카카오페이','pending','','2026-08-02 02:45:06',NULL);
